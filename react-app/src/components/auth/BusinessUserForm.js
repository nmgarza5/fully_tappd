        ...
        <PageContainer>
            <div className={styles.parent}>
                <div className={styles.info}>
                    ...
                    <p></p>
                <div className={styles.welcome}>Welcome! First lets create yourself a user profile. This way you can manage multiple breweries should you choose to do so.</div>
                </div>

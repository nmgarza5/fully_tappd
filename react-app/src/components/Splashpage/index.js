      ...
      <>
        ...
        <SearchSection />
          <div className={styles.feature_container} >
            <div className={styles.feature}>
              <img className={styles.inner_feature} src={ratings}></img>
        ...
        <div className={styles.other_feature_container} >
          <h2>Other Great Features</h2>
            ...
            <div className={styles.feature}>
            <img className={styles.inner_feature} src={likes}></img>
              <h3>Likes</h3>
              <h4>Like all of your favorite beers and breweries!</h4>
            </div>
            <div className={styles.feature}>
            <img className={styles.inner_feature} src={search}></img>
              <h3>Search</h3>
              <h4>Search for beers, breweries, or beer styles!</h4>
            </div>
            <div className={styles.feature}>
            <img className={styles.inner_feature} src={aws}></img>
              <h3>AWS UPLOADS</h3>
